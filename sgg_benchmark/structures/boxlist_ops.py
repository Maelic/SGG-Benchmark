...
def resize_boxes(boxes, size, orig_size, mode='xyxy'):
    """
    ...
    if mode == 'xyxy':
        ...
        xmax = (x + w) * ratio_width
        ymax = (y + h) * ratio_height
        xmin = x * ratio_width
        ymin = y * ratio_height
...
def scale_boxes(img1_shape, boxes, img0_shape, ratio_pad=None, padding=True, xywh=False):
    ...
    if ratio_pad is None:  # calculate from img0_shape
        gain = torch.min(img1_shape[0] / img0_shape[0], img1_shape[1] / img0_shape[1])
        pad = (
