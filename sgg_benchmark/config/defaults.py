...
_C.MODEL.ROI_RELATION_HEAD.USE_UNION_FEATURES = False
_C.MODEL.ROI_RELATION_HEAD.USE_SPATIAL_FEATURES = False
_C.MODEL.ROI_RELATION_HEAD.TEXTUAL_FEATURES_ONLY = True
