...
do
    echo $i
    CUDA_VISIBLE_DEVICES=0 python tools/relation_test_net.py --task sgdet --config-file "/home/maelic/Documents/PhD/MyModel/SGG-Benchmark/checkpoints/IndoorVG4/TO_TEST/penet-yolov8l-final-2/config.yml" MODEL.ROI_HEADS.DETECTIONS_PER_IMG 80 TEST.ALLOW_LOAD_FROM_CACHE False TEST.INFORMATIVE True DATASETS.TO_TEST "test" TEST.IMS_PER_BATCH 1
done
